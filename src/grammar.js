module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$startRuleFunctions = { import: peg$parseimport },
        peg$startRuleFunction  = peg$parseimport,

        peg$c0 = function() { rp(new BS.Import(true)) },
        peg$c1 = function() { rp(new BS.Bool(true)) },
        peg$c2 = function() { rp(new BS.Bool(false)) },
        peg$c3 = /^[0-9]/,
        peg$c4 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c5 = /^[0-9a-fA-F]/,
        peg$c6 = { type: "class", value: "[0-9a-fA-F]", description: "[0-9a-fA-F]" },
        peg$c7 = /^[0-7]/,
        peg$c8 = { type: "class", value: "[0-7]", description: "[0-7]" },
        peg$c9 = /^[01]/,
        peg$c10 = { type: "class", value: "[01]", description: "[01]" },
        peg$c11 = function(i) { rp(new CS.Identifier(i)); },
        peg$c12 = /^[$_]/,
        peg$c13 = { type: "class", value: "[$_]", description: "[$_]" },
        peg$c14 = "true",
        ...
        peg$c109 = /^[0-9\u0660-\u0669\u06F0-\u06F9\u07C0-\u07C9\u0966-\u096F\u09E6-\u09EF\u0A66-\u0A6F\u0AE6-\u0AEF\u0B66-\u0B6F\u0BE6-\u0BEF\u0C66-\u0C6F\u0CE6-\u0CEF\u0D66-\u0D6F\u0E50-\u0E59\u0ED0-\u0ED9\u0F20-\u0F29\u1040-\u1049\u1090-\u1099\u17E0-\u17E9\u1810-\u1819\u1946-\u194F\u19D0-\u19D9\u1A80-\u1A89\u1A90-\u1A99\u1B50-\u1B59\u1BB0-\u1BB9\u1C40-\u1C49\u1C50-\u1C59\uA620-\uA629\uA8D0-\uA8D9\uA900-\uA909\uA9D0-\uA9D9\uAA50-\uAA59\uABF0-\uABF9\uFF10-\uFF19]/,
    ...
    function peg$parseZWJ() {
      ...
      var BS = require("./nodes");

      // Store raw parse info
      var r = function(node){
