...
const createInstance$2 = function (template, processor, state, overrideDefinitionCache = false) {
    if (processor == null) {
...
const Element = Bram$1(HTMLElement);
Bram$1.Element = Element;
Bram$1.model = toModel;
Bram$1.on = on;
Bram$1.off = off;
Bram$1.createInstance = createInstance;
